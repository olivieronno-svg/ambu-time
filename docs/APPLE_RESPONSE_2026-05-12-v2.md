# Réponse Resolution Center — Build 1.0.26 (52)
...
Thank you for your feedback on build 1.0.25 (51). For build 1.0.26 (52) we have made the following changes to fully resolve all outstanding issues:
...
The dedicated support page is live at:

  https://olivieronno-svg.github.io/ambu-time/

Contains: contact email, FAQ section, privacy policy link, account deletion procedure.
